                ...
                <nav class="sidenav shadow-right sidenav-light">
                    <div class="sidenav-menu">
                        <div class="nav accordion" id="accordionSidenav">
                            ...
                            <a class="nav-link collapsed" href="../participant/listepart.php" data-toggle="collapse" data-target="#collapseLayouts" aria-expanded="false" aria-controls="collapseLayouts"
            ...
            <div id="layoutSidenav_content">
                <main>
                        ...
                        <div class="container-fluid">
                            <div class="page-header-content">
                                <h1 class="page-header-title">
                                    ...
                                    <span>Table des événements</span>
                                </h1>
                            </div>
                        </div>
                    </div>
                    ...
                    <?php
                        ...
                        // appeler la fonction list pour selectionner les donnees du table evenement
                        $res = $recrut->list();
                    ?>
                    <div class="container-fluid mt-n10">
                        <div class="card mb-4">
                            <div class="card-header">
                                <a class="btn btn-success" href="../../ajoutevent.html">Ajouter une événement</a>
                                <form action="trievent.php" method="get" class="form-inline">
                                    <select class="custom-select my-1 mr-sm-2" style="margin-left: 750px;" name="typetri" onchange="this.form.submit()">
                                        ...
                                        <option value="type_event">type </option>
                                        <option value="date_db">date début</option>
                                    </select>
                                </form>
                            </div>
                            <div class="card-body">
                                <div class="datatable table-responsive">
                                    ...
                                    <table class="table table-bordered table-hover" id="dataTable" width="100%" cellspacing="0">
                                        ...
                                        <!-- recuperation les donnee du table evenement et les afficher -->
                                        <?php
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                            <a class="btn btn-danger" onclick="return confirm('Are you sure you want to delete this item?');" href="deleteevent.php?id=<?php echo $ligne[0]; ?>">Supprimer</a>
                                            <a class="btn btn-success"  href="../../modifevent.php?id=<?php echo $ligne[0]; ?>&nom_event=<?php echo $ligne[1]; ?>&type_event=<?php echo $ligne[2] ?>&datedb=<?php echo $ligne[3] ?>&datefin=<?php echo $ligne[4] ?>">Modifier</a>
                                            </td>
                                        </tr>
                                        <?php 
                                            }
