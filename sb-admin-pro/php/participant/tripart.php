                ...
                <div class="container-fluid mt-n10">
                    <div class="card mb-4">
                        <div class="card-header">
                            <a class="btn btn-success" href="../../ajoutpart.html">Ajouter un participant</a>
                                    ...
                                    ?>
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>
                                                    <a class="btn btn-danger" data-confirm="Are you sure to delete this item?" href="deletepart.php?id=<?php echo $ligne[0]; ?>">Supprimer</a>
