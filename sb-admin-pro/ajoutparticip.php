                ...
                <nav class="sidenav shadow-right sidenav-light">
                    <div class="sidenav-menu">
                        <div class="nav accordion" id="accordionSidenav">
                            ...
                            <a class="nav-link collapsed" href="php/participant/listepart.php" data-toggle="collapse" data-target="#collapseLayouts" aria-expanded="false" aria-controls="collapseLayouts"
                                ><div class="nav-link-icon"><i data-feather="layout"></i></div>
                                Gestion des paticipants
                                <div class="sidenav-collapse-arrow"><i class="fas fa-angle-down"></i></div
                            ></a>
                            <a class="nav-link collapsed" href="php/evenement/listevent.php" data-toggle="collapse" data-target="#collapseLayouts" aria-expanded="false" aria-controls="collapseLayouts"
                                ><div class="nav-link-icon"><i data-feather="layout"></i></div>
                        ...
                        <div class="card mb-4">
                            <div class="card-body">
                                <div class="datatable table-responsive">
                                    <!-- la formulaire d'ajout un evenement-->
                                    <form action="php/participant/ajoutpart.php" method="POST">
                                        <div class="form-group">
                                            <label class="small mb-1" for="inputCin">Numéro carte d'identité National</label>
                                            <input class="form-control py-4" name="cin" id="cin" type="text" placeholder="Entre le n°CIN" required/>
                                        </div>
                                        <div class="form-group">
                                            <label class="small mb-1" for="inputNom">Nom du participant</label>
                                            <input class="form-control py-4" name="nom" id="nom" type="text" placeholder="Entrer le nom de participant" required/>
                                        </div>
                                        <div class="form-group">
                                            <label class="small mb-1" for="inputPrenom">Prenom du participant</label>
                                            <input class="form-control py-4" name="prenom" id="prenom" type="text" placeholder="Entrer le prenom de participant" required/>
                                        </div>
                                        <?php include("php/evenement.php"); ?>
                                        <?php 
                                            $recrut = new Evenement();
                                            // appeler la fonction list pour selectionner les nom des evenements
                                            $res = $recrut->list();
                                        ?>
                                        <div class="form-group">
                                            <label for="exampleFormControlSelect1">nom d'evenement</label>
                                            <select name="id_event" class="form-control" id="exampleFormControlSelect1">
                                                <?php
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" name="adresse" id="adresse" type="text" placeholder="Entrer l'adresse de participant"  />
                                        </div>
                                        <div class="form-group">
                                            <label class="small mb-1" for="inputNumTel">Numéro de téléphone</label>
                                            <input class="form-control col-md-3" name="num_tel" id="num_tel" type="text" placeholder="Entrer le numero de télephone" required/>
                                        </div>
                                        <button class="btn btn-success" onclick="return verifpart()" type="submit">Ajouter</button>
                                    </form>
                                </div>
                            </div>
                        </div>
