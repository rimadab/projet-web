...
<head>
    ...
    <body class="nav-fixed">
        <nav class="topnav navbar navbar-expand shadow navbar-light bg-white" id="sidenavAccordion">
            ...
            <?php 
                // récuperation des donnee le participant a modifier                              
                $id =  $_GET['id'];
                $nom =  $_GET['nom'];
                $prenom =  $_GET['prenom'];
                $cin =  $_GET['cin'];
                        ...
                        <div class="container-fluid">
                            <div class="page-header-content">
                                <h1 class="page-header-title">
                                    ...
                                    <span>Modifier d'un participant</span>
                                </h1>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card mb-4">
                            <div class="card-body">
                                <div class="datatable table-responsive">
                                    <!-- formulaire pour la modification d'un participant -->
                                    <form action="php/participant/modifierpart.php?id=<?php echo $id; ?>" method="POST">
                                        <div class="form-group">
                                            <label class="small mb-1" for="inputCin">Numéro carte d'identité National</label>
                                            <input class="form-control py-4" name="cin" id="cin" type="text" value="<?php echo $cin; ?>" placeholder="Entre le n°CIN" required />
                                        </div>
                                        <div class="form-group">
                                            <label class="small mb-1" for="inputNom">Nom du participant</label>
                                            <input class="form-control py-4" name="nom" id="nom" type="text" value="<?php echo $nom; ?>" placeholder="Entrer le nom de participant" required/>
                                        </div>
                                        <div class="form-group">
                                            <label class="small mb-1" for="inputPrenom">Prenom du participant</label>
                                            <input class="form-control py-4" name="prenom" id="prenom" type="text" value="<?php echo $prenom; ?>" placeholder="Entrer le prenom de participant" required/>
                                        </div>
                                        <div class="form-group">
                                            <label class="small mb-1" for="inputAdresse">Adresse</label>
                                            <input class="form-control" name="adresse" id="adresse" type="text" value="<?php echo $adresse; ?>" placeholder="Entrer l'adresse de participant"  required/>
                                        </div>
                                        <div class="form-group">
                                            <label class="small mb-1" for="inputNumTel">Numéro de téléphone</label>
                                            <input class="form-control col-md-3" name="num_tel" id="num_tel" type="text" value="<?php echo $num_tel; ?>" placeholder="Entrer le numero de télephone" required/>
                                        </div>
                                        <button class="btn btn-success" type="submit" onclick='return verifpart()'>Modifier</button>
                                    </form>
                                </div>
                            </div>
                        </div>
