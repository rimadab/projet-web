        ...
        <div id="layoutSidenav">
            ...
            <div id="layoutSidenav_content">
                <main>
                        ...
                        <div class="container-fluid">
                            <div class="page-header-content">
                                <h1 class="page-header-title">
                                    ...
                                    <span>Modifier d'une événement</span>
                                </h1>
                    ...
                    <?php 
                        // récuperation des donnee le l'evenement a modifier               
                        $id =  $_GET['id'];
                        ...
                        <div class="card mb-4">
                            <div class="card-body">
                                <div class="datatable table-responsive">
                                    <!-- la formulaire pour modifier un evenement-->
                                    <form action="php/evenement/modifierevent.php?id=<?php echo $id; ?>" method="POST">
                                        <div class="form-group">
                                            <label class="small mb-1" for="inputNomEvent">Nom d'événement</label>
                                            <input class="form-control py-4" name="nom" id="nom" type="text" value="<?php echo $nom_event; ?>" placeholder="Entrer le nom d'événement" required/>
                                        </div>
                                        <div class="form-group">
                                            <label class="small mb-1" for="inputTypeEvent">type d'événement</label>
                                            <input class="form-control py-4" name="type" id="type" type="text" value="<?php echo $type_event; ?>" placeholder="Entrer le type d'événement" required/>
                                        </div>
                                        <div class="form-group">
                                            <label class="small mb-1" for="inputDateDb">Date début</label>
                                            <input class="form-control col-md-3" name="datedb" id="datedb" value="<?php echo $datedb; ?>" type="date"  required/>
                                        </div>
                                        <div class="form-group">
                                            <label class="small mb-1" for="inputDateFin">Date fin</label>
                                            <input class="form-control col-md-3" name="datefin" id="datefn" value="<?php echo $datefn; ?>" type="date"  required/>
                                        </div>
                                        <button class="btn btn-success" type="submit" onclick='return verifevent()' >Modifier</button>
                                    </form>
                                </div>
                            </div>
                        </div>
